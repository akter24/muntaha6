<?php
	include('dbconnect.php');
	  ...
	  $sql="INSERT INTO offertable(product_name,product_price,image) values('$product_name','$product_price','$image')";
...
<img src="photo/banner.jpg" alt="Forest" width="100%" height="300px" style="overflow:hidden;padding-top:100px;">
	...
	<!-- header section ends-->
	  ...
	  <div style="width:360px;height:300px;background-color:#d3f1f0;margin-left:100px;border:2px solid green;border-radius:5px;padding-top:0px;">
	       <h2 style="height:50px;width:100%;background-color:green;padding-top:0px;text-align:center;"> Insert Offer Product</h2>
		  <form style="margin-left:50px;" action="insertofferproduct.php" method="POST" enctype="multipart/form-data">
