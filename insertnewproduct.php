<?php
	include('dbconnect.php');
	  ...
	  $sql="INSERT INTO product(product_name,product_price,image) values('$product_name','$product_price','$image')";
...
<img src="photo/banner.jpg" alt="Forest" width="100%" height="300px" style="overflow:hidden;padding-top:100px;">
	...
	<!-- header section ends-->
	  ...
	  <div style="width:360px;height:300px;background-color:#d3f1f0;margin-left:100px;border:2px solid green;border-radius:5px;padding-top:0px;">
	       <h2 style="height:50px;width:100%;background-color:green;padding-top:0px;text-align:center;"> Insert New Product</h2>
		  <form style="margin-left:50px;" action="insertnewproduct.php" method="POST" enctype="multipart/form-data">
			  <label for=""> Product Name:</label><br>
			  <input class="input" type="text" name="product_name" value="" placeholder=" Enter Product Name" required><br><br>
			  <label for=""> Product price:</label><br>
			  <input class="input"type="text" name="product_price" value="" placeholder=" Enter Product price" required><br><br>
			  <label for=""> Choose an Image:</label><br>
			  <input type="file" name="image" value="" required><br><br><br>
			   <input class="btn" type="submit" name="upload" value="Conferm insert" required style="width:100px;font-size:12px;">
			    <a href="newproducttable.php"> <input class="btn" type="btn" name="" value="View Insert" style="width:100px;font-size:12px;"></a>
		  </form>
