  ...
  <body class="body">
	...
	<header class="header">
		...
		<nav class="navber">
			...
			<a href="insertofferproduct.php">insertofferproduct</a>
			<a href="insertnewproduct.php">insertnewproduct</a>
	...
	<!-- home section ends-->
	  ...
	  <div class="tableview">
		<h1 style="color:green;text-align:center;"> Our Offer Product  Table List</h1>
				<table>
				<th>ID </th>
				<th>Product Name </th>
				<th>Product price</th>
				...
				<td> <a href="deleteoffer.php?Del=<?php echo $info['id']?>"><input style="color:red;font-size:20px;" type="button" class="btn btn-primary" value="Delete" onclick="return confirm('Are you sure you want to delete this item')" ></a></td> 
				<td> <a href="edit.php?Getid=<?php echo $info['id']?>"><input type="button" class="btn btn-primary" value="Edit" style="font-size:20px;"></a></td> 
				</tr>
				<?php
				}
		...
		<section class="footer">
			<div class="box-container">
				...
				<div class="box">
					 ...
					 <a href="links"><i class="fas fa-arrow-right"></i> features</a>
					 <a href="links"><i class="fas fa-arrow-right"></i> products</a>
					 <a href="links"><i class="fas fa-arrow-right"></i> catagories</a>
					 <a href="links"><i class="fas fa-arrow-right"></i> review</a>
					 <a href="links"><i class="fas fa-arrow-right"></i> blogs</a>
				</div>
