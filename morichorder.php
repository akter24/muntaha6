<?php
	...
	$sql="INSERT INTO ordertable(customer_name,mobile,product_name,quantity,amount,transition_id,transition_date,payment_type,address)
	values('$customer_name','$mobile','$product_name','$quantity','$amount','$transition_id','$transition_date','$payment_type','$address')";
...
<!-- Location  section start-->
	<section class="location" id="location">
		...
		<div class="row">
			<div class="image">
			  <img src="photo/morich/combiamorich.jpg" alt="image">
			</div>
	...
	<section class="more" id="more">
		...
		<div class="swiper more-slider">
			<div class="swiper-wrapper">
				...
				<img src="photo/morich/m1.jpg" alt="image">
			   ...
			   <div class="swiper-slide box">
				<img src="photo/morich/m2.jpg" alt="image">
				<h3>Muntaha Khati Moricher Gura</h3>
				 <div class="price"> Tk.280/- per kg</div>
				 <div class="stars">
					<i class="fas fa-star"></i>
			   ...
			   <div class="swiper-slide box">
				<img src="photo/morich/m3.jpg" alt="image">
				<h3>Muntaha Khati Moricher Gura</h3>
				 <div class="price"> Tk.280/- per kg</div>
				 <div class="stars">
					<i class="fas fa-star"></i>
			   ...
			   <div class="swiper-slide box">
				<img src="photo/morich/m4.jpg" alt="image">
				<h3>Muntaha Khati Moricher Gura</h3>
				 <div class="price"> Tk.280/- per kg</div>
				 <div class="stars">
					<i class="fas fa-star"></i>
