	<?php 
	  ...
	  $id=$_GET['Getid'];
	  $query="select * from offertable where id='".$id."'";
			...
			<br><div class="update">
				...
				<form  method="POST" action="update.php?ID=<?php echo $id ?>">
						...
						<br><input  class="submit" type="submit" name="update" value="Confirm Update" onclick="myFunction()">
			         	<a href="offerproducttable.php" style="padding-left:10px;"> <input class="button" type="button" name="" value="View Update" style="padding-left:5px;"></a>
				</form>
